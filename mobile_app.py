...
def _render_month_card(p):
    ...
    <g clip-path="url(#potm-clip)">
      ...
      <text x="150" y="316" font-family="Arial,sans-serif" font-weight="700" font-size="10" fill="#00d8ff" text-anchor="middle" letter-spacing="3">MAN OF THE MONTH · {month_label}</text>
...
def coach_matches():
    ...
    <div class="card"><h2>Tutte le partite ({len(rows)})</h2>{match_list or 'Nessuna partita.'}</div><a class="btn btn-blue" href="/coach">Indietro</a>
    """
