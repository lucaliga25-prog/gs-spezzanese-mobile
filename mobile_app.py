...
# Logo GS Spezzanese codificato in base64 — servito inline e come PWA icon.
...
def page(title, subtitle, content):
    ...
    <meta name="apple-mobile-web-app-title" content="GS Spezzanese">
    <link rel="apple-touch-icon" href="/logo.jpg">
    <link rel="manifest" href="/manifest.json">
    <link rel="icon" href="/favicon.ico" type="image/jpeg">
    <title>{title} · GS Spezzanese</title>
    {BASE_STYLE}</head>
    <body>
    <div class="header">
...
def serve_manifest():
    ...
    manifest = {
        "name": "GS Spezzanese",
        "short_name": "GS Spezzanese",
        "description": "Gestionale GS Spezzanese - voti e statistiche squadra",
        "start_url": "/",
        "display": "standalone",
